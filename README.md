...
Программа написана на 2 курсе университета.Задача: перести число записанное буквами на немецком, в его цифровой эквивалент и это же число перевести в римские цифры. Сделать проверку на грамматику и В случае ошибоки при вводе вывести соотвествующее сообщение.
